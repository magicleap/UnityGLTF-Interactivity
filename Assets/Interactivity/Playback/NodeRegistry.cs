...
namespace UnityGLTF.Interactivity
{
    public static class NodeRegistry
    {
        ...
        private static readonly Dictionary<string, Func<BehaviourEngine, Node, BehaviourEngineNode>> nodeTypes = new()
        {
            ...
            ["math/extract2x2"] = (engine, node) => new MathExtract2(engine, node),
            ["math/extract3x3"] = (engine, node) => new MathExtract3(engine, node),
            ["math/extract4x4"] = (engine, node) => new MathExtract4(engine, node),
