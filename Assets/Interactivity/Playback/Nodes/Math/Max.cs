    ...
    public class MathMax : BehaviourEngineNode
    {
        ...
        public override IProperty GetOutputValue(string id)
        {
            ...
            return a switch
            {
                ...
                Property<Vector2> aProp when b is Property<Vector2> bProp => new Property<Vector2>(math.max(aProp.value, bProp.value)),
                Property<Vector3> aProp when b is Property<Vector3> bProp => new Property<Vector3>(math.max(aProp.value, bProp.value)),
                Property<Vector4> aProp when b is Property<Vector4> bProp => new Property<Vector4>(math.max(aProp.value, bProp.value)),
